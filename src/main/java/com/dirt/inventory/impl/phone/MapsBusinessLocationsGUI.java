...
public class MapsBusinessLocationsGUI extends InventoryGUI {
    private final DirtEconomy plugin;
    private final int page;
    private final String searchFilter;

    public MapsBusinessLocationsGUI(DirtEconomy plugin, int page, String searchFilter) {
        this.plugin = plugin;
        this.page = page;
    ...
    protected Inventory createInventory() {
        return Bukkit.createInventory(null, 54, "\u00a72\u00a7lBusiness Locations");
    }
    ...
    public void decorate(Player player) {
        ...
        List<GPSLocation> locations = new ArrayList<>(plugin.getGpsManager().getBusinessLocations());
        ...
        for (int i = start; i < end; i++) {
            ...
            if (gps.getBusinessId() != null) {
                BusinessData biz = plugin.getBusinessManager().loadBusiness(gps.getBusinessId());
                bizName = biz != null ? biz.getName() : "Unknown";
            }
            String finalBizName = bizName;
            addButton(slot, new InventoryButton()
                    .creator(p -> ItemUtil.buildItem(XMaterial.COMPASS, "\u00a7e" + gps.getName(),
                            "\u00a76Business: \u00a7f" + finalBizName,
        ...
        addButton(46, new InventoryButton()
                ...
                .consumer(e -> {
                    Player p = (Player) e.getWhoClicked();
                    plugin.getChatInputManager().requestInput(p, "\u00a7eSearch business locations:", term ->
                            plugin.getGUIManager().openGUI(new MapsBusinessLocationsGUI(plugin, 0, term), p));
                })
        );
        ...
        if (page > 0) {
            addButton(45, new InventoryButton()
                    ...
                    .consumer(e -> plugin.getGUIManager().openGUI(new MapsBusinessLocationsGUI(plugin, page - 1, searchFilter), (Player) e.getWhoClicked()))
            );
        }
