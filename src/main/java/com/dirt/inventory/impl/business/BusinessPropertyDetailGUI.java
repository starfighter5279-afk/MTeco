...
import com.dirt.inventory.impl.nation.PropertyPermissionsGUI;
import com.dirt.inventory.impl.nation.RolePermsGUI;
...
public class BusinessPropertyDetailGUI extends InventoryGUI {
    ...
    public BusinessPropertyDetailGUI(DirtEconomy plugin, UUID businessId, UUID propertyId) {
        this.plugin = plugin;
    ...
    public void decorate(Player player) {
        ...
        addButton(4, new InventoryButton()
                ...
                .consumer(e -> {
                    ...
                    plugin.getGUIManager().openGUI(new com.dirt.inventory.impl.nation.PropertyManageGUI(plugin, propertyId,
                            com.dirt.inventory.impl.nation.PropertyManageGUI.PropertyType.BUSINESS, businessId), p);
                })
        );
