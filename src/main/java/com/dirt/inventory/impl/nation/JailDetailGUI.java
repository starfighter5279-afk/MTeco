...
public class JailDetailGUI extends InventoryGUI {
    ...
    public JailDetailGUI(DirtEconomy plugin, UUID nationId, UUID jailId) {
        this.plugin = plugin;
        ...
        addButton(15, new InventoryButton()
                ...
                .consumer(e -> {
                    ...
                    for (UUID cid : jail.getCellIds()) {
                        for (CriminalRecord rec : plugin.getLawCrimeManager().getCriminalsInCell(cid)) {
                    ...
                    p.sendMessage("\u00a7cJail deleted and prisoners released.");
