...
public class PresidentRegionDetailGUI extends InventoryGUI {
    ...
    public PresidentRegionDetailGUI(DirtEconomy plugin, UUID regionId, UUID nationId) {
        this.plugin = plugin;
    ...
    public void decorate(Player player) {
        ...
        addButton(13, new InventoryButton()
                .creator(p -> ItemUtil.buildItem(XMaterial.GOLD_NUGGET, "§eSet Property Chunk Rate",
                        ...
                        "§7Collection interval: §b" + region.getPropertyCollectionIntervalDays() + " MC day(s)",
