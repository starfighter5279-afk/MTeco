...
public class RoomCharacterEditGUI extends InventoryGUI {
    ...
    public RoomCharacterEditGUI(DirtEconomy plugin, UUID roomId, UUID characterId, Runnable saveCallback, Consumer<Player> backCallback) {
        this.plugin = plugin;
        this.roomId = roomId;
    ...
    protected Inventory createInventory() {
        ...
        String name = cd != null ? cd.getFirstName() + " " + cd.getLastName() : "Character";
        return Bukkit.createInventory(null, 27, "\u00a76Perms: " + name);
    }
    ...
    public void decorate(Player player) {
        ...
        CharacterData cd = plugin.getCharacterManager().getCharacter(characterId);
        String charName = cd != null ? cd.getFirstName() + " " + cd.getLastName() : "Character";
        ...
        for (int i = 0; i < PERM_KEYS.length; i++) {
            ...
            addButton(slot, new InventoryButton()
                    ...
                    .consumer(e -> {
                        ...
                        plugin.getGUIManager().openGUI(new RoomCharacterEditGUI(plugin, roomId, characterId, saveCallback, backCallback), (Player) e.getWhoClicked());
                    })
            );
        }
