...
public class LegislatedCrimesGUI extends InventoryGUI {
    ...
    public LegislatedCrimesGUI(DirtEconomy plugin, UUID nationId, boolean fromPresident, int page) {
        this(plugin, nationId, fromPresident, page, null);
    }

    public LegislatedCrimesGUI(DirtEconomy plugin, UUID nationId, boolean fromPresident, int page, Consumer<UUID> onSelect) {
        this.plugin = plugin;
