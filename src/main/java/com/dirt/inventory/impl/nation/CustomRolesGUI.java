...
public class CustomRolesGUI extends InventoryGUI {
    ...
    public CustomRolesGUI(DirtEconomy plugin, UUID nationId) {
        this(plugin, nationId, 0);
    }

    public CustomRolesGUI(DirtEconomy plugin, UUID nationId, int page) {
        this.plugin = plugin;
                ...
                .consumer(e -> {
                    ...
                    plugin.getChatInputManager().requestInput(p, "\u00a7eEnter a name for the new role:", name -> {
                        ...
                        if (plugin.getDiscordBotManager() != null) {
                            plugin.getDiscordBotManager().onCustomRoleCreated(n, newRole);
                        }
