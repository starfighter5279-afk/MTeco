...
public class CharacterPropertiesGUI extends InventoryGUI {
    ...
    public CharacterPropertiesGUI(DirtEconomy plugin, int page) {
        this.plugin = plugin;
        this.page = page;
    ...
    public CharacterPropertiesGUI(DirtEconomy plugin, int page, UUID targetUuid) {
        this.plugin = plugin;
        this.page = page;
    ...
    public void decorate(Player player) {
        ...
        for (int i = start; i < end; i++) {
            ...
            com.dirt.data.NationData nation = region != null ? plugin.getNationManager().loadNation(region.getNationId()) : null;
        ...
        if (!adminMode) {
            addButton(48, new InventoryButton()
                    ...
                    .consumer(e -> {
                        ...
                        com.dirt.data.NationData nation = plugin.getNationManager().loadNation(region.getNationId());
