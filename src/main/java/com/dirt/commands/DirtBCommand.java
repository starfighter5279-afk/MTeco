...
import com.dirt.inventory.impl.business.AllBusinessesGUI;
...
public class DirtBCommand implements CommandExecutor, TabCompleter {
    private final DirtEconomy plugin;

    public DirtBCommand(DirtEconomy plugin) {
        this.plugin = plugin;
    }
