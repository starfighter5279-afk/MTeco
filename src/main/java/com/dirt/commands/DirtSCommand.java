...
public class DirtSCommand implements CommandExecutor, TabCompleter {
    private final DirtEconomy plugin;

    public DirtSCommand(DirtEconomy plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        player.sendMessage("\u00a76DirtEconomy \u00a78\u2014 \u00a77Shop Commands");
        player.sendMessage("\u00a7e/ds online \u00a78- \u00a77Browse online shops");
        player.sendMessage("\u00a7e/ds top \u00a78- \u00a77View wealthiest players");
        return true;
    }
