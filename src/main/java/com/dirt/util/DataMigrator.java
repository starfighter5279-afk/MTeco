...
public class DataMigrator {
    ...
    public static void migrate(DirtEconomy plugin) {
    ...
    private static boolean migrateFolder(DirtEconomy plugin, File oldDir, File newDir) {
        newDir.mkdirs();
    ...
    private static boolean migrateSingleFile(DirtEconomy plugin, File oldFile, File newFile) {
