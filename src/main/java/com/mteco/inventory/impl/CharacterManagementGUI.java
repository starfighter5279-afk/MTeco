...
import com.mteco.inventory.impl.business.JobStatusGUI;
import com.mteco.inventory.impl.business.MyBusinessesGUI;
import com.mteco.inventory.impl.contract.ContractListGUI;
...
public class CharacterManagementGUI extends InventoryGUI {
    ...
    public CharacterManagementGUI(MTeco plugin) {
        this.plugin = plugin;
        this.targetUuid = null;
        this.adminMode = false;
    }

    public CharacterManagementGUI(MTeco plugin, UUID targetUuid) {
        this.plugin = plugin;
