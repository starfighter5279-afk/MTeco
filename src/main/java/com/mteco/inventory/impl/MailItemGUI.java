...
import com.mteco.inventory.impl.contract.ContractViewGUI;
import com.mteco.inventory.impl.contract.ContractBehalfOfGUI;
...
public class MailItemGUI extends InventoryGUI {
    ...
    public MailItemGUI(MTeco plugin, MailItem mail) {
        this.plugin = plugin;
        this.mail = mail;
    }
    ...
    private void decorateNationInvite(Player player) {
        ...
        addButton(11, new InventoryButton()
                ...
                .consumer(e -> {
                    Player p = (Player) e.getWhoClicked();
                    if (nationIdStr.isEmpty() || !plugin.isMTNationsEnabled()) {
    ...
    private void decorateJobOffer(Player player) {
        ...
        addButton(11, new InventoryButton()
                ...
                .consumer(e -> {
                    Player p = (Player) e.getWhoClicked();
                    if (businessId.isEmpty() || !plugin.isMTBusinessEnabled()) {
                    ...
                    if (!biz.getEmployeeUUIDs().contains(p.getUniqueId())) {
                        ...
                        com.mteco.data.BusinessRole defaultRole = biz.getDefaultRole();
                ...
                .consumer(e -> {
                    ...
                    if (biz != null) {
                        plugin.getGUIManager().openGUI(
                                new com.mteco.inventory.impl.business.BusinessSaleDenyGUI(plugin, bizId), p);
                    } else {
                        plugin.getGUIManager().openGUI(new MailGUI(plugin, 0), p);
                    }
                })
