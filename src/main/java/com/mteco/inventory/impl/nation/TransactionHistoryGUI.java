...
import com.mteco.data.NationTransaction;
...
public class TransactionHistoryGUI extends InventoryGUI {
    ...
    public TransactionHistoryGUI(MTeco plugin, UUID nationId, boolean canWithdraw) {
        this(plugin, nationId, canWithdraw, 0);
    }

    public TransactionHistoryGUI(MTeco plugin, UUID nationId, boolean canWithdraw, int page) {
        this.plugin = plugin;
