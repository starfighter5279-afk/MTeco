...
public class PropertyManageGUI extends InventoryGUI {
    ...
    public PropertyManageGUI(MTeco plugin, UUID propertyId, PropertyType type, UUID contextId) {
        this.plugin = plugin;
    ...
    private void decorateBusiness(Player player) {
        ...
        com.mteco.data.BusinessData biz = plugin.getBusinessManager().loadBusiness(contextId);
        ...
        addButton(22, new InventoryButton()
                ...
                .consumer(e -> plugin.getGUIManager().openGUI(
                        new com.mteco.inventory.impl.business.BusinessPropertyDetailGUI(plugin, contextId, propertyId), (Player) e.getWhoClicked()))
        );
    }
