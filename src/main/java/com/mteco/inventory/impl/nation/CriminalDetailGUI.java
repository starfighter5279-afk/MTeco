...
public class CriminalDetailGUI extends InventoryGUI {
    ...
    public CriminalDetailGUI(MTeco plugin, UUID nationId, UUID recordId, Supplier<InventoryGUI> backSupplier) {
        this.plugin = plugin;
        ...
        if (active) {
            addButton(13, new InventoryButton()
                    ...
                    .consumer(e -> {
                        ...
                        Player criminal = Bukkit.getPlayer(record.getCriminalUUID());
                        if (criminal != null) criminal.sendMessage("\u00a7aYou have been released from your criminal sentence.");
