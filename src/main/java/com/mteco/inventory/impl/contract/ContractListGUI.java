...
import com.mteco.inventory.impl.business.BusinessManagementGUI;
...
public class ContractListGUI extends InventoryGUI {
    ...
    public ContractListGUI(MTeco plugin, List<ContractData> contracts, int page, InventoryGUI backGui) {
        this.plugin = plugin;
    ...
    public ContractListGUI(MTeco plugin, UUID businessId, UUID playerUuid, int page) {
        this.plugin = plugin;
        this.page = page;
