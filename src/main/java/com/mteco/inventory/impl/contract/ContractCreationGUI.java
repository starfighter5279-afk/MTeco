...
public class ContractCreationGUI extends InventoryGUI {
    ...
    public ContractCreationGUI(MTeco plugin) {
        this.plugin = plugin;
    }

    public ContractCreationGUI(MTeco plugin, java.util.UUID playerUuid) {
        this.plugin = plugin;
    }

    public ContractCreationGUI(MTeco plugin, ContractData draft) {
        this.plugin = plugin;
    ...
    static void promptBodyInput(MTeco plugin, ContractData draft, Player player, boolean append) {
