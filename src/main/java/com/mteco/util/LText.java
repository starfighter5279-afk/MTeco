...
public class LText {
    ...
    public static void handleInput(MTeco plugin, Player player, String input,
    ...
    public static void handleInput(MTeco plugin, Player player, String input, Consumer<String> onText) {
        handleInput(plugin, player, input, onText, null);
    }

    private static void sync(MTeco plugin, Runnable r) {
