...
public class NationPermissionUtil {
    ...
    public static boolean hasPermission(MTeco plugin, NationData nation, UUID playerUUID, NationPermission permission) {
    ...
    private static boolean hasLegacyPermission(MTeco plugin, NationData nation, UUID playerUUID, NationPermission permission) {
    ...
    public static String getRoleDisplayName(MTeco plugin, NationData nation, UUID playerUUID) {
    ...
    public static Set<NationPermission> getPlayerPermissions(MTeco plugin, NationData nation, UUID playerUUID) {
    ...
    public static boolean requiresCouncilVote(MTeco plugin, NationData nation, UUID playerUUID) {
        if (nation == null || playerUUID == null) return false;
    ...
    public static boolean executeOrVote(MTeco plugin, NationData nation, UUID playerUUID,
